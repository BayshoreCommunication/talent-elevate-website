    ...
    <div className="bg-secondary py-10 md:py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 flex flex-col md:flex-row justify-center items-stretch gap-x-10 gap-y-10">
          {/* Pro Plan */}
          <MotionFadeIn delay={0.1} className="w-full max-w-md">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-md p-8 flex flex-col h-full">
              ...
              <ul className="space-y-2 text-lg text-gray-700 flex-1">
                ...
                <li className="flex items-center">
                  <span className="mr-2 text-green-600">✓</span> Resume +
                  LinkedIn + Shell Exp.
                </li>
                <li className="flex items-center">
          ...
          {/* Success Plan */}
          <MotionFadeIn delay={0.2} className="w-full max-w-md">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-md p-8 flex flex-col h-full">
              ...
              <ul className="space-y-2 text-lg text-gray-700 flex-1">
                <li className="flex items-center">
                  <span className="mr-2 text-green-600">✓</span> Same services
                  as Pro Plan
                </li>
                <li className="flex items-center">
                ...
                <li className="flex items-center">
                  <span className="mr-2 text-green-600">✓</span> No time
                  pressure
                </li>
                <li className="flex items-center">
